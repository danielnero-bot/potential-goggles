...
import { FiMail, FiLock, FiChevronLeft, FiAlertCircle } from "react-icons/fi";
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark p-6 flex flex-col">
      <header className="pt-8 mb-12">
        ...
        <p className="text-text-secondary-light dark:text-text-secondary-dark font-bold text-sm">Sign in to your account</p>
      </header>
      ...
      <div className="mt-8 text-center pb-8 text-sm font-bold text-text-secondary-light dark:text-text-secondary-dark">
        New here? <Link to="/signup" className="text-primary uppercase tracking-widest text-xs ml-1">Create Account</Link>
      </div>
    </div>
  );
};
